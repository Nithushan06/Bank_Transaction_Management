...
import bank_transaction_management.utils.FileHandler;
import javax.swing.*;
...
public class Account_Management extends javax.swing.JFrame {
    ...
    int vip = 0;
        ...
        BankData.AccountNode temp = BankData.accountList.getHead();
        while (temp != null) {
            total++;
            if (temp.closed) {
                closed++;
                ...
                active++;
                if ("VIP".equals(temp.accountType)) {
                    vip++;   
                }
            }
            temp = temp.next;
    ...
    jTextField5.setText(String.valueOf(active));
    jTextField6.setText(String.valueOf(closed));
    jTextField7.setText(String.valueOf(vip));
}
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Active Accounts");

        jLabel7.setText("Closed Accounts");

        jLabel8.setText("VIP Accounts");
